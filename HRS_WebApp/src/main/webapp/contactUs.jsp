...
%>
	<HEADER>
		...
		<DIV class="navbar navbar-inverse navbar-fixed-top">
			...
			<b><DIV class="container">
					...
					<H1>
						<a href="index.jsp" class="navbar-brand">Hotel Reservation Website</a>
					</H1>
					...
					<form action="user">
						...
						<DIV class="modal-footer">
							<a class="mr" href="#signUp" data-toggle="modal"
								data-dismiss="modal">New to HRS? Sign Up</a> <input
	...
	<DIV class="bdy container-fluid mt">
		...
		<div class="col-sm-4 col-sm-offset-4">
			...
			<h4 class="cmt">Trung T. Nguyen</h4>
			<h4>nttrungmt@gmail.com</h4>		
